 ...
 *       将复杂对象的构建与表示分离</li>
 *   <li><b>Facade 模式</b>：{@link com.pasterdream.pasterdreammod.api.item.ItemAPI}
 *       提供统一入口，屏蔽内部实现细节</li>
 ...
 * <pre>{@code
 * // 注册一个稀有材料
 * import static com.pasterdream.pasterdreammod.api.item.ItemAPI.*;
 * 
 ...
 *   <li><b>{@code manager/}</b> — 迁移状态管理（{@code ItemManager}）</li>
 ...
 * </ul>
 *
 * @see com.pasterdream.pasterdreammod.api.item.ItemAPI
 * @see com.pasterdream.pasterdreammod.api.item.builder.SimpleItemBuilder
 * @see com.pasterdream.pasterdreammod.api.item.builder.FoodItemBuilder
 * @see com.pasterdream.pasterdreammod.api.item.builder.ToolItemBuilder
 * @see com.pasterdream.pasterdreammod.api.item.builder.CurioItemBuilder
 * @see com.pasterdream.pasterdreammod.api.item.manager.ItemManager
 * @see com.pasterdream.pasterdreammod.api.item.model.ItemSpec
 * @see com.pasterdream.pasterdreammod.api.item.model.FoodSpec
 * @see com.pasterdream.pasterdreammod.api.item.model.MigrationCategory
