...
import com.pasterdream.pasterdreammod.api.item.gen.LootTableGenerator;
import com.pasterdream.pasterdreammod.api.item.gen.LootTableGenerator.DropEntry;
...
public final class BlockLootAPI {
    ...
    public static void selfDropAll(String... blockNames) {
        PasterDreamAPI.LOGGER.debug("[BlockLootAPI] selfDropAll() 生成 {} 个方块战利品表", blockNames.length);
    ...
    public static void oreDropAll(OreDropPair... drops) {
        PasterDreamAPI.LOGGER.debug("[BlockLootAPI] oreDropAll() 生成 {} 个矿石战利品表", drops.length);
    ...
    public static void variantSetDropAll(String baseName) {
        PasterDreamAPI.LOGGER.debug("[BlockLootAPI] variantSetDropAll() 生成 {} 变体族战利品表", baseName);
    ...
    public static void batchDropSelf(String baseName, int... indices) {
        PasterDreamAPI.LOGGER.debug("[BlockLootAPI] batchDropSelf() {} 生成 {} 个方块战利品表", baseName, indices.length);
    ...
    public static void batchDropSelfRange(String baseName, int start, int end, int... excludeIndices) {
        ...
        PasterDreamAPI.LOGGER.debug("[BlockLootAPI] batchDropSelfRange() 完成: {}, 生成 {} 个", baseName, count);
    }
