 ...
 * ===========================================================================
 */
package com.pasterdream.pasterdreammod.api.item.example;

import com.pasterdream.pasterdreammod.api.PasterDreamAPI;
import com.pasterdream.pasterdreammod.api.item.ItemAPI;
import com.pasterdream.pasterdreammod.api.item.builder.*;
import com.pasterdream.pasterdreammod.api.item.gen.LanguageGenerator;
import com.pasterdream.pasterdreammod.api.item.manager.ItemManager;
import com.pasterdream.pasterdreammod.api.item.model.*;
...
public class ItemAPIExample {
    ...
    static {
        ...
        System.out.println("  ItemAPI 示例类已加载");
     ...
     * 演示如何注册简单材料物品
     * <p>
     * 使用 {@link ItemAPI#simpleItem(String)} 创建构建器，
    ...
    public static void demoSimpleMaterials() {
        ...
        // ========== 示例 1: 稀有材料, 限堆叠16个, 防火 ==========
        ItemAPI.simpleItem("example_rare_gem")
        ...
        // ========== 示例 2: 史诗材料 ==========
        ItemAPI.simpleItem("example_epic_shard")
        ...
        // ========== 示例 3: 普通材料, 默认属性 ==========
        ItemAPI.simpleItem("example_common_dust")
        ...
        // 用 ItemSpec 注册:
        // ItemAPI.simpleItem(spec.registryName())
     ...
     * 演示如何注册食物物品
     * <p>
     * 使用 {@link ItemAPI#foodItem(String)} 创建构建器，
    ...
    public static void demoFoodItems() {
        ...
        // ========== 示例 1: 普通食物 ==========
        ItemAPI.foodItem("example_hearty_stew")
        ...
        // ========== 示例 2: 始终可食的食物（如药水/饮料） ==========
        ItemAPI.foodItem("example_magic_tea")
                .nutrition(2)
        ...
        ItemAPI.foodItem("example_energy_candy")
                .nutrition(4)
        ...
        ItemAPI.foodItem("example_golden_apple_juice")
                .nutrition(6)
     ...
     * 演示如何注册工具和武器物品
     * <p>
     * 使用 {@link ItemAPI#toolItem(String)} 创建构建器，
    ...
    public static void demoToolsAndWeapons() {
        ...
        // ===== 剑 =====
        ItemAPI.toolItem("example_crystal_sword")
        ...
        // ===== 镐 =====
        ItemAPI.toolItem("example_nether_pickaxe")
        ...
        // ===== 斧 =====
        ItemAPI.toolItem("example_stone_axe")
        ...
        // ===== 锹 =====
        ItemAPI.toolItem("example_iron_shovel")
        ...
        // ===== 锄 =====
        ItemAPI.toolItem("example_wooden_hoe")
        ...
        // ===== 锤（模组自定义） =====
        ItemAPI.toolItem("example_war_hammer")
        ...
        // ===== 法杖（模组自定义） =====
        ItemAPI.toolItem("example_magic_wand")
     ...
     * 演示如何注册 Curio 饰品
     * <p>
     * 使用 {@link ItemAPI#curioItem(String)} 创建构建器，
    ...
    public static void demoCurioItems() {
        ...
        // ========== 示例 1: 戒指, 增加攻击力 ==========
        ItemAPI.curioItem("example_power_ring")
                .slot("ring")                       // 槽位: 戒指
        ...
        // ========== 示例 2: 项链, 增加生命值 ==========
        ItemAPI.curioItem("example_vitality_necklace")
                .slot("necklace")                   // 槽位: 项链
        ...
        // ========== 示例 3: 腰带, 增加护甲 ==========
        ItemAPI.curioItem("example_guard_belt")
                .slot("belt")                       // 槽位: 腰带
        ...
        // ========== 示例 4: 护符, 增加移动速度和击退抗性 ==========
        ItemAPI.curioItem("example_swift_charm")
                .slot("charm")                      // 槽位: 护符
        ...
        // ========== 示例 5: 头饰槽位 ==========
        ItemAPI.curioItem("example_crown")
                .slot("head")                       // 槽位: 头部
     ...
     * 可使用 {@link ItemAPI#registerCustom(String, java.util.function.Supplier)}
     * 直接注册自定义的 Item 子类实例。
     * </p>
     */
     ...
     * 演示批量注册功能
     * <p>
     * 使用 {@link ItemAPI#batchSimpleItems(ItemSpec...)} 批量注册简单材料，
     * 使用 {@link ItemAPI#batchFoodItems(Map)} 批量注册食物物品。
    ...
    public static void demoBatchRegistration() {
        ...
        // List<DeferredItem<Item>> simpleResults = ItemAPI.batchSimpleItems(
        ...
        // List<DeferredItem<Item>> batchResults = ItemAPI.batchSimpleItems(specs);
        System.out.println("    - 使用 ItemSpec.Builder 定义了 " + specs.length + " 个规格");

        // ========== 批量注册食物物品 ==========
        // 使用 Map.of 构建名称到 FoodSpec 的映射
        // List<DeferredItem<Item>> foodResults = ItemAPI.batchFoodItems(Map.of(
        ...
        // ItemAPI.batchFoodItems(foodMap);
     ...
     * 演示迁移状态追踪功能
     * <p>
     * 使用 {@link ItemAPI#markMigrated(MigrationCategory, String...)} 标记已迁移物品，
     * 使用 {@link ItemAPI#markPending(MigrationCategory, String...)} 标记待迁移物品，
     * 最后通过 {@link ItemAPI#generateReport()} 生成完整的迁移进度报告。
     * </p>
     */
     ...
     * 演示语言文件生成功能
     * <p>
     * 使用 {@link ItemAPI#generateLangJson(String, Map)} 生成本地化 JSON，
    ...
    public static void demoLanguageGeneration() {
        ...
        // ========== 方式 1: 使用 API 门面方法 ==========
        String langJson = ItemAPI.generateLangJson(modId, Map.of(
    ...
    public static void main(String[] args) {
        System.out.println(SEPARATOR);
        System.out.println("  ItemAPI 示例程序启动");
        ...
        // 总结
        System.out.println("\n" + SEPARATOR);
        System.out.println("  ItemAPI 示例程序执行完毕");
