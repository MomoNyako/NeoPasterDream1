...
public class MobEffectBuilder {
    ...
    public MobEffectBuilder(String name) {
        this.name = name;
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] 创建效果构建器: {}", name);
    }
    ...
    public MobEffectBuilder beneficial() {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → category=BENEFICIAL", name);
        return this;
    }
    ...
    public MobEffectBuilder harmful() {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → category=HARMFUL", name);
        return this;
    }
    ...
    public MobEffectBuilder neutral() {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → category=NEUTRAL", name);
        return this;
    }
    ...
    public MobEffectBuilder category(MobEffectCategory category) {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → category={}", name, category.name());
        return this;
    }
    ...
    public MobEffectBuilder color(int color) {
        this.color = color;
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → color=#{}", name, Integer.toHexString(color));
        return this;
    }
    ...
    public MobEffectBuilder instant() {
        this.instant = true;
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → instant=true", name);
        return this;
    }
    ...
    public MobEffectBuilder shaderTexture(ResourceLocation shaderTexture) {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → shaderTexture={}", name, shaderTexture);
        return this;
    }
    ...
    public MobEffectBuilder particleType(ParticleType<?> particleType) {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → particleType={}", name, particleType);
        return this;
    }
    ...
    public MobEffectBuilder onApply(BiConsumer<LivingEntity, Integer> onApply) {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → onApply=已配置", name);
        return this;
    }
    ...
    public MobEffectBuilder onRemove(BiConsumer<LivingEntity, Integer> onRemove) {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → onRemove=已配置", name);
        return this;
    }
    ...
    public MobEffectBuilder stackingHandler(
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] {} → stackingHandler=已配置", name);
        return this;
    }
    ...
    public MobEffectResult build() {
        PasterDreamMod.LOGGER.info("[MobEffectBuilder] ===== 开始构建效果: {} =====", name);
        validate();
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] 注册 MobEffect: {} (category={}, color=#{})",
        ...
        PasterDreamMod.LOGGER.info("[MobEffectBuilder] ✅ MobEffect 已注册: {} | holder={} | instant={}", name, holder, instant);

        // 创建结果
        MobEffectResult result = new MobEffectResult(name, holder);
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] 创建 MobEffectResult: name={}, holder={}", name, holder);
    ...
    private void validate() {
        if (category == null) {
            PasterDreamMod.LOGGER.error("[MobEffectBuilder] ❌ 验证失败: {} → category 未设置", name);
            throw new IllegalStateException("MobEffectBuilder: 缺少效果分类（category），请调用 .beneficial() / .harmful() / .neutral() 设置");
        }
        if (color == null) {
            PasterDreamMod.LOGGER.error("[MobEffectBuilder] ❌ 验证失败: {} → color 未设置", name);
            throw new IllegalStateException("MobEffectBuilder: 缺少效果颜色（color），请调用 .color() 设置");
        }
        PasterDreamMod.LOGGER.debug("[MobEffectBuilder] ✅ 验证通过: {}", name);
    }
}