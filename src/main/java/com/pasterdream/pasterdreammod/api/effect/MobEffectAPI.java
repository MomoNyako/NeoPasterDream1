...
public final class MobEffectAPI {
    ...
    public static MobEffectBuilder createEffect(String effectName) {
        PasterDreamMod.LOGGER.info("[MobEffectAPI] 开始创建效果构建器: {}", effectName);
    ...
    public static MobEffectResult getEffect(String effectName) {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectAPI] 🔍 查询效果: {} → {}", effectName, result != null ? "已找到" : "未找到");
        return result;
    }
    ...
    public static MobEffect getEffectType(String effectName) {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectAPI] 🔍 查询效果类型: {} → {}", effectName, effect != null ? effect : "null");
        return effect;
    }
    ...
    public static Supplier<MobEffect> getEffectSupplier(String effectName) {
        MobEffectResult result = REGISTERED_EFFECTS.get(effectName);
        if (result != null) {
            PasterDreamMod.LOGGER.debug("[MobEffectAPI] 🔍 查询效果 Supplier: {}", effectName);
            return result::effect;
        }
        PasterDreamMod.LOGGER.debug("[MobEffectAPI] 🔍 查询效果 Supplier: {} → null（未找到）", effectName);
        return null;
    }
    ...
    public static PasterDreamEffect getPasterDreamEffect(String effectName) {
        ...
        if (result != null) {
            ...
            PasterDreamMod.LOGGER.debug("[MobEffectAPI] 🔍 查询 PasterDreamEffect: {} → {}", effectName, pde != null ? "是自定义效果" : "不是自定义效果");
            return pde;
        }
        PasterDreamMod.LOGGER.debug("[MobEffectAPI] 🔍 查询 PasterDreamEffect: {} → null（未找到）", effectName);
        return null;
    }
    ...
    public static Map<String, MobEffectResult> getRegisteredEffects() {
        ...
        PasterDreamMod.LOGGER.debug("[MobEffectAPI] 📊 获取所有已注册效果: 共 {} 个", count);
    ...
    public static void cacheEffect(MobEffectResult result) {
        ...
        PasterDreamMod.LOGGER.info("[MobEffectAPI] 📦 已缓存效果: {} | 缓存总数: {} | holder={}",
