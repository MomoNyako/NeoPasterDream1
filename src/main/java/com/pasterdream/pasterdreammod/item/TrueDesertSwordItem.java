...
public class TrueDesertSwordItem extends SwordItem {
    ...
    private static final Tier TRUEDESERTSWORDITEM_TIER = new SimpleTier(
    ...
    public TrueDesertSwordItem() {
        super(TRUEDESERTSWORDITEM_TIER, new Item.Properties().attributes(
            SwordItem.createAttributes(TRUEDESERTSWORDITEM_TIER, 3, -3.1f)
        ));
    }
