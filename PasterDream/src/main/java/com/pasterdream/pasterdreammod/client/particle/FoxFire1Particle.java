...
/**
 * 狐火粒子 1 (Fox Fire 1 Particle)
 * <p>
 * 用于狐火实体散发的红色半透明火焰粒子，为橙色狐火提供色彩变体。
 * 行为与 {@link FoxFire0Particle} 一致，仅在纹理和色调上区分。
 */
public class FoxFire1Particle extends TextureSheetParticle {
     ...
     * @param spriteSet 精灵表
     */
    protected FoxFire1Particle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new FoxFire1Particle(level, x, y, z, vx, vy, vz, this.sprites);
        }
    }
}
